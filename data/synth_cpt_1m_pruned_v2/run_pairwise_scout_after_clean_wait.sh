...
SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS=${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS:-2}
SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_STRATEGY=${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_STRATEGY:-near_spread}
SCOUT_TAG=${SCOUT_TAG:-unsolved_v63template_component_feedback_scout_d10_tc3_tail${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t120_w80_fb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v63template_component_feedback_pairwise_currentref_solvedonly_timeoutfb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}_secondary_v1}
...
SCOUT_CANDIDATE_DEPTH_EVAL_LIMIT=${SCOUT_CANDIDATE_DEPTH_EVAL_LIMIT:-10}
SCOUT_CANDIDATE_TEMPLATE_BACKFILL_EXTRA_SLOTS=${SCOUT_CANDIDATE_TEMPLATE_BACKFILL_EXTRA_SLOTS:-8}
SCOUT_CANDIDATE_DEPTH_TYPE_EVAL_CAP=${SCOUT_CANDIDATE_DEPTH_TYPE_EVAL_CAP:-3}
SCOUT_CANDIDATE_DEPTH_TEMPLATE_EVAL_SLOTS=${SCOUT_CANDIDATE_DEPTH_TEMPLATE_EVAL_SLOTS:-1}
...
SCOUT_CANDIDATE_ADAPTIVE_TYPE_PENALTY_REASONS=${SCOUT_CANDIDATE_ADAPTIVE_TYPE_PENALTY_REASONS:-point_too_close,point_too_far,point_already_exists,unknown_point,invalid_quad_solve,dep_check_fail,invalid_line_intersect,value_error,invalid_predicate}
...
SCOUT_CANDIDATE_DDAR_TIMEOUT=${SCOUT_CANDIDATE_DDAR_TIMEOUT:-120}
SCOUT_CANDIDATE_WALL_TIMEOUT=${SCOUT_CANDIDATE_WALL_TIMEOUT:-80}
...
SCOUT_SEARCH_DEPTH=${SCOUT_SEARCH_DEPTH:-3}
SCOUT_NUM_RETURN_SEQUENCES=${SCOUT_NUM_RETURN_SEQUENCES:-36}
