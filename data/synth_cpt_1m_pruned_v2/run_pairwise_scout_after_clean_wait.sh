...
SCOUT_TAG=${SCOUT_TAG:-unsolved_v59validation_error_penalty_scout_d10_tc3_tail${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t120_w80_fb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v59validation_error_penalty_pairwise_currentref_solvedonly_timeoutfb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}_secondary_v1}
...
SCOUT_CANDIDATE_ADAPTIVE_TYPE_PENALTY_REASONS=${SCOUT_CANDIDATE_ADAPTIVE_TYPE_PENALTY_REASONS:-point_too_close,point_too_far,point_already_exists,unknown_point,invalid_quad_solve,dep_check_fail,invalid_line_intersect,value_error}
