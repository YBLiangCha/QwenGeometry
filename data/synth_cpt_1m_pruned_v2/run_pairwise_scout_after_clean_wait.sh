...
SCOUT_TAG=${SCOUT_TAG:-unsolved_v41rerank_diagnostics_scout_d16_tc4_tail${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t160_w100_fb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v41rerank_diagnostics_pairwise_currentref_solvedonly_timeoutfb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}_secondary_v1}
