...
CLEAN_CANDIDATE_ADAPTIVE_TYPE_PENALTY_REASONS=${CLEAN_CANDIDATE_ADAPTIVE_TYPE_PENALTY_REASONS:-point_too_close,point_too_far,point_already_exists,unknown_point,invalid_quad_solve,dep_check_fail,invalid_line_intersect,value_error}
