...
CLEAN_SECONDARY_VALUE_MODEL=${CLEAN_SECONDARY_VALUE_MODEL:-outputs/candidate_value_model_v59validation_error_penalty_pairwise_currentref_solvedonly_timeoutfb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}_secondary_v1/candidate_value_model.json}
...
CLEAN_RERUN_TAG=${CLEAN_RERUN_TAG:-unsolved_v59validation_error_penalty_stage4_d48_tc6_tail${CLEAN_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t240_w150_fb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
