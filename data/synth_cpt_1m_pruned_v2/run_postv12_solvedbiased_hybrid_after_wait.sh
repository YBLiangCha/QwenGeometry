...
SCOUT_TAG=${SCOUT_TAG:-unsolved_factctx_promptaug_top8_hybrid_v12_front8_progress_v18coverage_ptype2_scout_depth16_typecap4_fact12_t160_w100_nrs48_qm3_timeoutfb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT:-4}append_progbeam_progprefix_factmem_binddedup_v1}
