...
SCOUT_TAG=${SCOUT_TAG:-unsolved_factctx_promptaug_top8_hybrid_v12_front8_progress_v21singles_ptype2_vprior2_softto5_scout_depth16_typecap4_fact12_t160_w100_nrs48_qm3_timeoutfb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT:-4}append_progbeam_progprefix_factmem_binddedup_v1}
...
CLEAN_RERUN_TAG=${CLEAN_RERUN_TAG:-unsolved_factctx_promptaug_top8_stage4_solvedbiased_postv12_hybrid_v12_front8_progress_v21singles_ptype2_vprior2_softto5_progbeam_decbeam${CLEAN_CANDIDATE_DECODE_BEAM_LIMIT}_depth24_typecap6_fact12_t200_w120_nrs48_qm3_timeoutfb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT}append_progprefix_factmem_binddedup_v1}
