...
CLEAN_SECONDARY_VALUE_MODEL=${CLEAN_SECONDARY_VALUE_MODEL:-outputs/candidate_value_model_v64prompt_component_feedback_pairwise_currentref_solvedonly_timeoutfb${SCOUT_TIMEOUT_BEAM_FALLBACK_LIMIT}_secondary_v1/candidate_value_model.json}
...
CLEAN_RERUN_TAG=${CLEAN_RERUN_TAG:-unsolved_v64prompt_component_feedback_stage4_d48_tc6_tail${CLEAN_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t240_w150_fb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
...
log "hybrid clean candidate depth template slots: $CLEAN_CANDIDATE_DEPTH_TEMPLATE_EVAL_SLOTS"
...
log "hybrid clean preferred type limits: prompt=$CLEAN_CANDIDATE_PROMPT_PREFERRED_TYPE_LIMIT; template=$CLEAN_CANDIDATE_TEMPLATE_PREFERRED_TYPE_LIMIT"
...
log "hybrid clean seed aux file: ${CLEAN_CANDIDATE_SEED_AUX_FILE:-none}; limit=${CLEAN_CANDIDATE_SEED_AUX_LIMIT}; frontfill=${CLEAN_CANDIDATE_SEED_AUX_FRONTFILL_LIMIT}"
...
env \
  ...
  CLEAN_CANDIDATE_SEED_AUX_FILE="$CLEAN_CANDIDATE_SEED_AUX_FILE" \
  CLEAN_CANDIDATE_SEED_AUX_LIMIT="$CLEAN_CANDIDATE_SEED_AUX_LIMIT" \
  CLEAN_CANDIDATE_SEED_AUX_FRONTFILL_LIMIT="$CLEAN_CANDIDATE_SEED_AUX_FRONTFILL_LIMIT" \
