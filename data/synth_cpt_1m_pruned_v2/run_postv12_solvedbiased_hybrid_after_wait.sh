...
SCOUT_TAG=${SCOUT_TAG:-unsolved_v53template_eval_reserve_scout_d16_tc4_tail${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t160_w100_fb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT:-4}append_v1}
...
CLEAN_SECONDARY_VALUE_MODEL=${CLEAN_SECONDARY_VALUE_MODEL:-outputs/candidate_value_model_v53template_eval_reserve_pairwise_currentref_solvedonly_timeoutfb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT:-4}_secondary_v1/candidate_value_model.json}
...
CLEAN_RERUN_TAG=${CLEAN_RERUN_TAG:-unsolved_v53template_eval_reserve_stage4_d48_tc6_tail${CLEAN_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t240_w150_fb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
