...
SCOUT_TAG=${SCOUT_TAG:-unsolved_v23near_scout_d16_tc4_tail${SCOUT_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t160_w100_fb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT:-4}append_v1}
...
CLEAN_RERUN_TAG=${CLEAN_RERUN_TAG:-unsolved_v23near_stage4_d24_tc6_tail${CLEAN_CANDIDATE_DEPTH_TAIL_EVAL_SLOTS}_fact12_t200_w120_fb${CLEAN_TIMEOUT_BEAM_FALLBACK_LIMIT}append_v1}
