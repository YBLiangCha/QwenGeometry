...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v31circle_tline_anchor_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v31circle_tline_anchor after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v31circle_tline_anchor scout and hybrid wrapper"
