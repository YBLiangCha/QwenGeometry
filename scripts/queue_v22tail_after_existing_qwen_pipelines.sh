...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v33dynamic_progress_anchor_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v33dynamic_progress_anchor after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v33dynamic_progress_anchor scout and hybrid wrapper"
...
log "dynamic progress type anchor: enabled=${CANDIDATE_DYNAMIC_PROGRESS_TYPE_ANCHOR}; min_delta=${CANDIDATE_DYNAMIC_PROGRESS_TYPE_MIN_DELTA}; base=${CANDIDATE_DYNAMIC_PROGRESS_TYPE_BONUS_BASE}; weight=${CANDIDATE_DYNAMIC_PROGRESS_TYPE_BONUS_WEIGHT}; max=${CANDIDATE_DYNAMIC_PROGRESS_TYPE_BONUS_MAX}"
