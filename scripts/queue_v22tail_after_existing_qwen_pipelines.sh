...
POSTRUN_TAG=${POSTRUN_TAG:-postv12_solvedbiased_hybrid_v40calibrated_mined_anchor_v1}
...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v40calibrated_mined_anchor_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v40calibrated_mined_anchor after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v40calibrated_mined_anchor scout and hybrid wrapper"
...
if [ "$MINE_STATIC_PROGRESS_TYPE_BONUS" = "1" ]; then
  ...
  log "mining static progress type bonus: out=${STATIC_PROGRESS_TYPE_BONUS_JSON}; min_delta=${STATIC_PROGRESS_TYPE_BONUS_MIN_DELTA}; topn=${STATIC_PROGRESS_TYPE_BONUS_TOPN}; base=${STATIC_PROGRESS_TYPE_BONUS_BASE}; delta_weight=${STATIC_PROGRESS_TYPE_BONUS_DELTA_WEIGHT}; repeat_weight=${STATIC_PROGRESS_TYPE_BONUS_REPEAT_WEIGHT}; repeat_cap=${STATIC_PROGRESS_TYPE_BONUS_REPEAT_CAP}; solved=${STATIC_PROGRESS_TYPE_BONUS_SOLVED_BONUS}; max=${STATIC_PROGRESS_TYPE_BONUS_MAX}"
