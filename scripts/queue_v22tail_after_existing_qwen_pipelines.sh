...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v35static_2020_progress_anchor_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v35static_2020_progress_anchor after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v35static_2020_progress_anchor scout and hybrid wrapper"
