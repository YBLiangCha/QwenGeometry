...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v30slowclean_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v30slowclean after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v30slowclean scout and hybrid wrapper"
