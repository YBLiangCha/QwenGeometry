...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v38aggregate_progress_anchor_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v38aggregate_progress_anchor after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v38aggregate_progress_anchor scout and hybrid wrapper"
