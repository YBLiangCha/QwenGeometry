...
POSTRUN_TAG=${POSTRUN_TAG:-postv12_solvedbiased_hybrid_v39mined_progress_anchor_v1}
...
STATIC_PROGRESS_TYPE_BONUS_MIN_DELTA=${STATIC_PROGRESS_TYPE_BONUS_MIN_DELTA:-50}
STATIC_PROGRESS_TYPE_BONUS_TOPN=${STATIC_PROGRESS_TYPE_BONUS_TOPN:-64}
STATIC_PROGRESS_TYPE_BONUS_MAX=${STATIC_PROGRESS_TYPE_BONUS_MAX:-3.4}
...
SCOUT_VALUE_TAG=${SCOUT_VALUE_TAG:-v39mined_progress_anchor_pairwise_currentref_solvedonly_timeoutfb4_secondary_v1}
...
log "queue v39mined_progress_anchor after existing Qwen pipelines"
...
log "no blocking Qwen pipeline active; launching v39mined_progress_anchor scout and hybrid wrapper"
...
if [ "$MINE_STATIC_PROGRESS_TYPE_BONUS" = "1" ]; then
  ...
  log "mining static progress type bonus: out=${STATIC_PROGRESS_TYPE_BONUS_JSON}; min_delta=${STATIC_PROGRESS_TYPE_BONUS_MIN_DELTA}; topn=${STATIC_PROGRESS_TYPE_BONUS_TOPN}; max=${STATIC_PROGRESS_TYPE_BONUS_MAX}"
